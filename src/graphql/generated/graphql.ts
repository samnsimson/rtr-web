...
export type RtrDetailQuery = { __typename?: 'Query', rtr: { __typename?: 'RtrResponse', id: string, candidateFirstName: string, candidateLastName: string, candidateEmail: string, candidatePhone: string, compensation: number, compensationType: CompensationType, status: RtrStatus, recruiterId: string, rtrTemplateId: string, candidateId?: string | null, createdById: string, expiresAt?: any | null, signedAt?: any | null, resumeRequired: boolean, photoIdRequired: boolean, referencesRequired: boolean, employerDetailsRequired: boolean, skillsRequired: boolean, job: { __typename?: 'JobResponse', id: string, title: string, company: string, location: string, description: string, requirements: Array<string>, benefits: Array<string> }, createdBy: { __typename?: 'User', id: string, name?: string | null } } };
