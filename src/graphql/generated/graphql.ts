...
export type CreateJobInput = {
  ...
  skillsRequired: Array<SkillRequirementInput>;
...
export type Job = {
  ...
  skillsRequired?: Maybe<Array<SkillRequirement>>;
...
export type Rtr = {
  ...
  rtrId?: Maybe<Scalars['String']['output']>;
  rtrTemplate: RtrTemplate;
...
export type RtrResponse = {
  ...
  rtrId?: Maybe<Scalars['String']['output']>;
  rtrTemplate: RtrTemplateResponse;
...
export type CompaniesQuery = { __typename?: 'Query', companies: Array<{ __typename?: 'CompanyResponse', name: string }> };
...
export type RtrDetailQueryVariables = Exact<{
  id: Scalars['String']['input'];
}>;


export type RtrDetailQuery = { __typename?: 'Query', rtr: { __typename?: 'RtrResponse', id: string, rtrId?: string | null, candidateFirstName: string, candidateLastName: string, candidateEmail: string, candidatePhone: string, compensation: number, compensationType: CompensationType, status: RtrStatus, recruiterId: string, rtrTemplateId: string, candidateId?: string | null, createdById: string, createdAt: any, expiresAt?: any | null, signedAt?: any | null, viewedAt?: any | null, notes?: string | null, resumeRequired: boolean, photoIdRequired: boolean, referencesRequired: boolean, employerDetailsRequired: boolean, skillsRequired: boolean, job: { __typename?: 'JobResponse', id: string, jobId?: string | null, starred: boolean, organizationId?: string | null, title: string, description: string, company: string, location: string, workType: WorkType, jobType: JobType, compensation: CompensationType, salaryMin?: number | null, salaryMax?: number | null, recruiterId: string, benefits: Array<string>, requirements: Array<string>, createdAt: any, updatedAt: any, expiresAt?: any | null, status: JobStatus }, createdBy: { __typename?: 'User', id: string, name?: string | null } } };
